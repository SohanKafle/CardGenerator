    ...
    <div class="max-w-screen-xl mx-auto px-4 py-6">
        ...
        <div class="flex justify-between items-center mb-12">
            ...
            <div class="flex justify-center items-center space-x-0 border border-gray-300 rounded-lg mx-auto w-full max-w-3xl">
                ...
                <!-- Search Button -->
                <button type="button" id="searchButton" class="bg-blue-600 text-white py-3 px-6 rounded-r-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 inline-block">
                    Search
                </button>
            </div>
        </div>
